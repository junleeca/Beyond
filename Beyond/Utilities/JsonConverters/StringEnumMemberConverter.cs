...
public class StringEnumMemberConverter : JsonConverterFactory
{
    ...
    internal class StringGenericEnumMemberConverter<T> : JsonConverter<T>
    {
        ...
        public StringGenericEnumMemberConverter(JsonNamingPolicy namingPolicy, bool allowIntegerValues,
            Type underlyingType)
        {
        ...
        public override T Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            if (token != JsonTokenType.Number || !allowIntegerValues) throw new JsonException();
        ...
        public override void Write(Utf8JsonWriter writer, T value, JsonSerializerOptions options)
        {
            ...
            if (!allowIntegerValues) throw new JsonException();
