using Beyond.Internals.Pluralizer;
using Beyond.Types;
...
public static class StringExtensions
{
    ...
    {
        return a?.StartsWith(b, StringComparison.OrdinalIgnoreCase) ?? false;
    }

    public static bool EndsWithIgnoreCase(this string a, string b)
    {
        return a?.EndsWith(b, StringComparison.OrdinalIgnoreCase) ?? false;
    }
    ...
    public static IEnumerable<int> IndicesOf(this string text, string searchFor)
    {
        ...
        var lastLoc = text.IndexOf(searchFor);
        while (lastLoc != -1)
        {
            yield return lastLoc;
            lastLoc = text.IndexOf(searchFor, lastLoc + 1);
        }
    }
    ...
    public static string[] Split(this string @this, string[] separators,
        StringSplitOptions option = StringSplitOptions.None)
    {
        return @this.Split(separators, option);
    }
